...
```{r, echo = F}
base_total <- bj %>% filter(origin_country_code %in% c("USA", "US")) %>%
...
fuel_total <- bj %>% filter(origin_country_code %in% c("USA", "US")) %>% 
...
other_total <- bj %>% filter(origin_country_code %in% c("USA", "US")) %>% 
  group_by(cass_shipment_id, mode, origin_postal_code, destination_postal_code) %>%
...
targeted_total <- bj %>% filter(origin_country_code %in% c("USA", "US")) %>% 
  group_by(cass_shipment_id, mode, origin_postal_code, destination_postal_code) %>%
